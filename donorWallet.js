...
const careItemDetails = {
    FOOD: {
        en: { name: 'Green Protein Food', price: 100, unit: 'portion', description: 'Balanced nutrition for three meals a day' },
        zh: { name: '提供環保蛋白質糧食', price: 100, unit: '份', description: '一日三餐的營養均衡飲食' }
    },
    INSURANCE: {
        en: { name: 'Medical Insurance', price: 268, unit: 'month', description: 'Comprehensive coverage for doctor visits and surgeries' },
        zh: { name: '購買動物醫療保險', price: 268, unit: '月', description: '全面承擔醫生及手術費用' }
    },
    COLLAR: {
        en: { name: 'Smart Collar', price: 330, unit: 'piece', description: 'IoT technology for automatic health monitoring' },
        zh: { name: '訂製智能保健頸圈', price: 330, unit: '件', description: '物聯網科技自動健康檢查' }
    },
    ADOPTION: {
...
const animalDetails = {
    ALLSTRAY: {
        ...
        zh: { name: '全體綠洲浪浪', description: '園區內所有需要照顧的浪浪' }
    },
    SQUIRREL: {
